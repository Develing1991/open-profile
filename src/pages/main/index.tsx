	...
	return (
		<section className="bg-main bg-cover bg-no-repeat w-full h-full flex flex-col justify-center items-center  ">
			...
			<div className="text-white flex flex-col gap-4">
				...
				<h2 className="text-3xl text-orange-200 font-semibold tracking-widest xl:text-9xl lg:text-7xl md:text-6xl sm:text-5xl max-sm:p-4  transition-all duration-1000 drop-shadow-lg hover:scale-110">
					DeveLLing1991
				</h2>
